...
<div class="container main-area">
	...
	<div class="question-block">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12  question-item qinfo">
				<?php
					$sQuery = "select * from quizes where email = '".$_SESSION['email']."'";
					$rows = R::getAll($sQuery);
					foreach ($rows as  $row) {
					echo "<a href='inforesult.php?code=".$row['code']."'> \n";
					echo "<i class='fa fa-info-circle'></i></a> \n";
					echo "<img class='col-md-1' src='img/quiz-title.png'> \n";
					echo "<h3> Quiz title: ".$row['title']." </h3> \n";
					echo "<h3> Quiz code: ".$row['code']." </h3> \n";
					echo '<hr>';
					}
				?>
